...
import pandas as pd
import numpy as np
import json, os, time, csv, math, sys
...
UNIVERS = [
    ...
    ("STM.MI",    "STMicroelectronics",   "Tech",       "MI"),
    ...
    ("OSE.PA",    "OSE Immuno",           "Sante",      "PA"),
    ("VIRP.PA",   "Virbac",               "Sante",      "PA"),
    ("EO.PA",     "Euroapi",              "Sante",      "PA"),
    ("GENFIT.PA", "Genfit",               "Sante",      "PA"),
    ("LNA.PA",    "LNA Sante",            "Sante",      "PA"),
    ("ORPEA.PA",  "Orpea",                "Sante",      "PA"),
    ("HCO.PA",    "Hippocrate",           "Sante",      "PA"),
    ("ABCA.PA",   "ABC Arbitrage",        "Finance",    "PA"),
    ("ALBON.PA",  "Bond",                 "Finance",    "PA"),
    ("CRBP2.PA",  "Banque Chaix",         "Finance",    "PA"),
    ("MERY.PA",   "Mersen",               "Industrie",  "PA"),
    ("POM.PA",    "Compagnie Plastic Om", "Industrie",  "PA"),
    ("MBWS.PA",   "Marie Brizard",        "Conso",      "PA"),
    ("CROS.PA",   "Crossject",            "Sante",      "PA"),
    ("LOUP.PA",   "Groupe Flo",           "Conso",      "PA"),
    ("SWP.PA",    "Sword Group",          "Tech",       "PA"),
    ("ITRK.PA",   "Interparfums",         "Conso",      "PA"),
    ("ALHIT.PA",  "Hitechpros",           "Tech",       "PA"),
    ("MMT.PA",    "M&G Real Estate",      "Immo",       "PA"),
    ("ICAD.PA",   "iCAD France",          "Tech",       "PA"),
    ("FDE.PA",    "Figeac Aero",          "Industrie",  "PA"),
    ("IALI.PA",   "Itesoft",              "Tech",       "PA"),
    ("ALOGT.PA",  "Obiz",                 "Tech",       "PA"),
    ("ALHPC.PA",  "HiPay",                "Tech",       "PA"),
    ("FII.PA",    "Fonciere INEA",        "Immo",       "PA"),
    ("CIFI.PA",   "Cife",                 "Industrie",  "PA"),
    ("LANC.PA",   "Laurent-Perrier",      "Conso",      "PA"),
    ("ELIS.PA",   "Elis",                 "Industrie",  "PA"),
    ("MDP.PA",    "Maisons du Monde",     "Conso",      "PA"),
    ("FNAC.PA",   "Fnac Darty",           "Conso",      "PA"),
    ("ALTX.PA",   "Altarea",              "Immo",       "PA"),
    ("ICOV.PA",   "Icovance",             "Sante",      "PA"),
    ("SELER.PA",  "Selectirente",         "Immo",       "PA"),
    ("CNP.PA",    "CNP Assurances",       "Finance",    "PA"),
    ("DG.PA",     "Vinci",                "Industrie",  "PA"),
    ("EDF.PA",    "Electricite de France","Energie",    "PA"),
    ("CMGE.PA",   "Credit Mutuel Arkea",  "Finance",    "PA"),
    ("CRSU.PA",   "Groupe CIR",           "Finance",    "PA"),
    ("BURP.PA",   "Bureau Veritas",       "Industrie",  "PA"),
    ("CVS.PA",    "Cegedim",              "Tech",       "PA"),
    ("EXA.PA",    "Exacompta",            "Industrie",  "PA"),
    ("KAZI.PA",   "Hachette",             "Telecom",    "PA"),
    ("OPM.PA",    "OPmobility",           "Industrie",  "PA"),
    ("ALLIX.PA",  "Allix",                "Tech",       "PA"),
    ("INEA.PA",   "INEA",                 "Immo",       "PA"),
    ("MALT.PA",   "Malteries Franco-Belges","Conso",    "PA"),
    ("IDIP.PA",   "IDI",                  "Finance",    "PA"),
    ("ASSHO.PA",  "Assystem",             "Industrie",  "PA"),
    ("NEOEN.PA",  "Neoen",                "Energie",    "PA"),
    ("ALWED.PA",  "Wedia",                "Tech",       "PA"),
    ("ALMII.PA",  "MII",                  "Tech",       "PA"),
    ("ALPDX.PA",  "Prodways",             "Industrie",  "PA"),
    ("IDSUD.PA",  "ID Logistics",         "Industrie",  "PA"),
    ("ALDBT.PA",  "DBT",                  "Tech",       "PA"),
    ("SRP.PA",    "SRPD",                 "Finance",    "PA"),
    ("MGIC.PA",   "MGI Coutier",          "Industrie",  "PA"),
    ("NEXTS.PA",  "Nextstage",            "Finance",    "PA"),
    ("ALREC.PA",  "Reworld Media",        "Telecom",    "PA"),
    # ── Amsterdam ────────────────────────────────────────────────────────────
    ...
    ("DSMF.AS",   "DSM-Firmenich",        "Materiaux",  "AS"),
    ...
    ("TKWY.AS",   "Just Eat Takeaway",    "Tech",       "AS"),
    ...
    ("BEFB.BR",   "Bekaert",              "Materiaux",  "BR"),
    ("MELX.BR",   "Melexis",              "Tech",       "BR"),
    ("UCO.BR",    "Umicore",              "Materiaux",  "BR"),
    ...
    ("SRBNK.OL",  "Sparebank 1 SR-Bank",  "Finance",    "OL"),
    ...
    ("REE.MC",    "Red Electrica",        "Utilities",  "MC"),
...
def sauvegarder(nouveaux):
    ...
    md  = ["# LA FIRME — PEA Screener Pro v3.1"]
...
def main():
    print("=" * 55)
    print("  LA FIRME — SCREENER PRO v3.1")
